...
namespace DS3TexUpUI
{
    internal static class Training
    {
        ...
        public static void UnzipData(IProgressToken token)
        {
        ...
        public static void CreateHR(IProgressToken token, string inputDir, string outputDir)
        {
        ...
        public static void CreateLR(IProgressToken token, string inputDir, string outputDir, LRCompression compression)
        {
